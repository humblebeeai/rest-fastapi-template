...
[**`examples/simple/main.py`**](https://github.com/humblebee/rest.fastapi-template/blob/main/examples/simple/main.py):
...
[**`examples/async/main.py`**](https://github.com/humblebee/rest.fastapi-template/blob/main/examples/async/main.py):
