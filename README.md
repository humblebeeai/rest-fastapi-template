...
[![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/humblebee/rest.fastapi-template/3.create-release.yml?logo=GitHub)](https://github.com/humblebee/rest.fastapi-template/actions/workflows/3.create-release.yml)
[![GitHub release (latest SemVer)](https://img.shields.io/github/v/release/humblebee/rest.fastapi-template?logo=GitHub)](https://github.com/humblebee/rest.fastapi-template/releases)
...
- If you want to use the template repository directly, just click the **[Use this template](https://github.com/new?template_name=rest.fastapi-template&template_owner=humblebee)** button and follow the instructions.
- You can use **cookiecutter** to generate a new project from **[cookiecutter](https://github.com/humblebee/rest.fastapi-template/tree/cookiecutter)** branch:

    ```sh
    # Clone the cookiecutter branch:
    git clone -b cookiecutter https://github.com/humblebee/rest.fastapi-template.git
...
- Install [**docker** and **docker compose**](https://docs.docker.com/engine/install)
    - Docker image: [**humblebee/rest.fastapi-template**](https://hub.docker.com/r/humblebee/rest.fastapi-template)
<!-- - *[OPTIONAL]* For **GPU (NVIDIA)**:
...
```sh
git clone https://github.com/humblebee/rest.fastapi-template.git && \
...
```sh
git clone git@github.com:humblebee/rest.fastapi-template.git && \
    cd rest.fastapi-template
```

**OPTION C.** Download source code:

1. Download archived **zip** or **tar.gz** file from [**releases**](https://github.com/humblebee/rest.fastapi-template/releases).
